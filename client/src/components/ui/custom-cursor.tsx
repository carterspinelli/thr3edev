...
export function CustomCursor({
  ...
  return (
    <motion.div
      className={cn(
        "pointer-events-none fixed left-0 top-0 z-50 flex aspect-square min-h-5 items-center justify-center rounded-full bg-primary px-1 text-center text-xs mix-blend-difference",
        className
      )}
