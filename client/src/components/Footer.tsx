        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className={`text-center md:text-left text-xs leading-relaxed max-w-xl ${theme === 'dark' ? 'text-zinc-400' : 'text-zinc-500'}`}>
              Transformamos ideas en experiencias digitales impactantes. Creamos landing pages de alto impacto en tiempo récord. Nuestro enfoque minimalista y orientado a resultados asegura que cada proyecto sea entregado en solo 3 días con la máxima calidad.
            </p>
          </motion.div>
