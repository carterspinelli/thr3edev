        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto relative">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-zinc-400 mb-10 tracking-tight max-w-3xl mx-auto">
            ...
            >
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="rounded-full px-10 py-6 border border-zinc-800 text-white hover:bg-zinc-900 font-medium"
                asChild
                onMouseEnter={() => setCursorVariant("sm")}
                onMouseLeave={() => setCursorVariant("default")}
              >
