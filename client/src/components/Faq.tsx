...
const faqData: FAQItem[] = [
  {
    ...
    answer: "El proceso comienza con una reunión de 30 minutos para entender tu negocio y necesidades. Inmediatamente después, empezamos a diseñar y desarrollar tu landing page utilizando las mejores tecnologías disponibles. Al tercer día, entregamos tu landing page completamente funcional junto con el código fuente.",
    icon: icons[0],
    iconPosition: "left"
  },
  {
    ...
    answer: "El precio fijo incluye diseño personalizado, desarrollo completo, optimización para dispositivos móviles, hosting por un año, entrega del código fuente completo y 1 mes de soporte técnico. No hay costos ocultos ni cargos adicionales.",
    icon: icons[1],
    iconPosition: "right"
  },
  {
  ...
  },
  {
    ...
    answer: "Creemos en la transparencia y en darte control total sobre tu landing page. Al entregar el código fuente, garantizamos que puedas modificarlo en el futuro con tu propio equipo si así lo deseas, o seguir trabajando con nosotros para actualizaciones y mejoras.",
    icon: icons[3],
    iconPosition: "right"
  },
  {
    ...
    answer: "Sí, el primer año de hosting está incluido en el precio. Después del primer año, ofrecemos planes de hosting a precios competitivos. En cuanto al dominio, podemos adquirirlo por ti (costo adicional) o puedes utilizar uno que ya hayas adquirido.",
    icon: icons[4],
    iconPosition: "left"
  }
];
